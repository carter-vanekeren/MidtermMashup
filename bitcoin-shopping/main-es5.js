...
var AppComponent = /** @class */ (function () {
    function AppComponent(coindesk, etsy) {
...
var CoindeskService = /** @class */ (function () {
    function CoindeskService(http) {
        this.http = http;
    }
    CoindeskService.prototype.getIndex = function () {
        var _this = this;
        this.http.get('https://api.coindesk.com/v1/bpi/currentprice/USD.json').subscribe(function (response) {
            _this.rate = response.bpi.USD.rate_float;
        });
    };
    CoindeskService.prototype.convertToBitcoin = function (price) {
        return price / this.rate;
    };
    CoindeskService.ctorParameters = function () { return [
...
var EtsyService = /** @class */ (function () {
    function EtsyService(http, coindesk) {
        this.http = http;
        this.coindesk = coindesk;
        this.listing = [];
    }
    EtsyService.prototype.getListing = function (searchWord) {
        var _this = this;
        var apiURL = 'https://openapi.etsy.com/v2/listings/active.js?api_key=oz6xd4p3dzohwypiaoeafrpa&limit=24';
        if (searchWord) {
            apiURL += '&keywords=' + searchWord;
        }
        return this.http.jsonp(apiURL, 'callback').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            var result = [];
            response.results.forEach(function (item) {
                result.push({
                    listing_id: item.listing_id,
                    description: item.description,
                    price: _this.coindesk.convertToBitcoin(+item.price),
                    url: item.url,
                    title: item.title
                });
            });
    ...
    EtsyService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var ListingComponent = /** @class */ (function () {
    function ListingComponent(etsy) {
        this.etsy = etsy;
        this.listing = [];
    ...
    ListingComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.etsy.getListing().subscribe(function (res) {
            _this.listing = res;
        }, function (error) {
            alert(error.message);
        });
    };
    ListingComponent.prototype.onSearch = function () {
        var _this = this;
        if (this.searchWord) {
            this.etsy.getListing(this.searchWord).subscribe(function (res) {
                _this.listing = res;
            }, function (error) {
                alert(error.message);
            });
    ...
    ListingComponent.prototype.goToItemPage = function (url) {
        window.open(url);
    };
